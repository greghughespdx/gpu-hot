...
This fixture records a non-simultaneous sample from host `inf2` at
2026-09-04T03:57:10Z. The source files were read over the read-only `inf2`
SSH route from `/sys/class/drm/card1/device` and
...
link behavior captured from inf2.
